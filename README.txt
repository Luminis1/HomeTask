...
хотя безусловно мы понимаем что нет предела совершенству и можно сделать еще лучше. Стремимся к этому.

  1. База данных. Миграции
        Была использована реляционная модель базы данных, а конкретно MySql. В будущем мы можем провести анализ
      "потребностей" проекта и более осознано подобрать технологии.
  ...
  4. Хранение информации(обьекта) о трите
        Хотелось бы поговорить о некоторых моментах. Я описывал дублировал это в комментария в коде, но скажу
      об это  и тут. На данный момент информация хранится одним куском. Я понимаю, что так этого делать нельзя,
      но в рамках тестового задания этого было достаточно. В будущем мы сможем обсудить, какие события будут
      случаться с объектом трита и спроектировать базу таким образом, что бы скорость работы с ним была максимальной,
  ...
  6. Создание трита
    ...
    Благодарю за внимание. Если возникнут вопросы сверх тех, что я описал тут - обращайтесь и я с радостью отвечу.
